...
### ¿Cuál de las 8 categorías resultó más difícil de encontrar en mi propio código y por qué?

Considero que las categorías mas difíciles sobre la que encontrar ejemplos en mi propio código han sido "Estándares" y "Consistencia". Esto es porque el problema es que no son errores lógicos que ves directamente, sino una falta de reglas comunes. Como es algo que depende delo que pensaba tu "yo" del pasado, es difícil saber si lo hiciste mal o si simplemente no tenías una norma fija que aplicar.
