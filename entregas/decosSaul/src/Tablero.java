public class Tablero {
  ...
  public boolean esCoordenadaValida(Coordenada coordenada) {
    return (coordenada.getFila() >= 1 && coordenada.getFila() <= casillas.length &&
        coordenada.getColumna() >= 1 && coordenada.getColumna() <= casillas[0].length);
  }
