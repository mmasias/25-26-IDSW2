...
|**Formato**|Ejemplo +|El uso de una constante MODO_DEBUG para el modo debug es un ejemplo excelente de buen formato. Permite cambiar el comportamiento de todo el programa en un solo sitio.| [Enlace a código](https://github.com/xImRaul/24-25-EDA2/blob/731eb39ebec13fc5b304ea5bb1fffd1ba32a4885/entregas/garciaRaul/src/RellenoInundacion.java#L6)
...
||Ejemplo -|	El método personasEnColaAlFinalizar se declara al principio del código, alargando su uso innecesariamente.|[Enlace PR corrección](https://github.com/ximraul/23-24-prg2/pull/1)
...
|**Consistencia**|Ejemplo +| Todo el proyecto sigue la misma consistencia lógica| [Enlace a código](https://github.com/xImRaul/24-25-EDA1/tree/ada07e89535ab1fbc062ee34cfda70435950e826/entregas/garciaRaul/Reto-005)
...
||Ejemplo -|Al declarar private NodoVersion raiz, Java ya le asigna null. Escribirlo en el constructor es redundante.|[Enlace PR corrección](https://github.com/ximraul/24-25-eda1/pull/3)
|**Código muerto**|Ejemplo +|Todo el código es funcional. No hay bloques de código que no usen o que sea injustificable.|[Enlace a código](https://github.com/xImRaul/24-25-EDA1/blob/ada07e89535ab1fbc062ee34cfda70435950e826/entregas/garciaRaul/Reto-004/Cancion.java)
||Ejemplo -|El valor true en el método validLine del principio nunca se lee. En cuanto entras al bucle do-while, lo primero que hace es sobrescribir ese valor con el resultado de la comparación.|[Enlace PR corrección](https://github.com/ximraul/24-25-eda1/pull/4)
