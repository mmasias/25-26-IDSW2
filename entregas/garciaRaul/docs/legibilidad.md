...
| | Ejemplo - | Los términos `numero1`, `numero2` y `numero3` no tienen significado claro. Al cambiarlos por `numeroCentenas`, `numeroDecenas` y `numeroUnidades` se entiende mejor el contexto. | [Enlace PR](https://github.com/ximraul/23-24-prg1/pull/3) |
...
| **Formato** | Ejemplo + | El uso de una constante `MODO_DEBUG` para gestionar el modo depuración es un excelente ejemplo de buen formato para centralizar el comportamiento. | [Enlace a código](https://github.com/xImRaul/24-25-EDA2/blob/731eb39ebec13fc5b304ea5bb1fffd1ba32a4885/entregas/garciaRaul/src/RellenoInundacion.java#L6) |
...
| | Ejemplo - | El uso de la variable `añadirClientes` usa caracteres Unicode. Se considera mejor práctica profesional cambiarlo por `agregarClientes`. | [Enlace PR](https://github.com/ximraul/24-25-eda1/pull/2) |
