...
|-|-|-|-|
|**Nombrado**|Ejemplo +|existePersona
||Ejemplo -|espacioParaPersona|[PR correcció](https://github.com/micastg3/24-25-EDA1/pull/1/changes/5d150dde7c08910cf5187b8f0ddfd387dc3553a4)n
||Ejemplo -|darCosas|[PR corrección](https://github.com/micastg3/24-25-EDA1/pull/1/changes/5d150dde7c08910cf5187b8f0ddfd387dc3553a4)
|**Comentarios**|Ejemplo +|No hay comentarios
||Ejemplo -||PR corrección
||Ejemplo -||PR corrección
|**Formato**|Ejemplo +|El formato es correcto
||Ejemplo -|El orden hace que algunas funciones se pierdan en el código|[PR corrección](https://github.com/micastg3/24-25-EDA1/pull/1/changes/5d150dde7c08910cf5187b8f0ddfd387dc3553a4)
||Ejemplo -||PR corrección
|**Estándares**|Ejemplo +|Se cumple un estandar durante todo el código, aunque quizás pasarlo a inglés podría ser mejor. Tiene todoos los ejemplos necesarios y sin comentar.
||Ejemplo -||PR corrección
||Ejemplo -||PR corrección
|**Consistencia**|Ejemplo +|Hay consistencia en todo el código
||Ejemplo -||PR corrección
||Ejemplo -||PR corrección
|**Código muerto**|Ejemplo +|No hay código muerto
||Ejemplo -||PR corrección
|**DRY**|Ejemplo +|No hay DRI
||Ejemplo -||PR corrección
|**YAGNI**|Ejemplo +|No hay YAGNI
||Ejemplo -||PR corrección

Quiero aclarar que esté código es el más antiguo que pude encontrar. La ausencia de DRI es porque fue lo primero que aprendí al venir a la uni, junto a la ausencia de comentarios