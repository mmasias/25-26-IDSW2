...
|**Comentarios**|[Ejemplo +](https://github.com/DylanNrj/24-25-EDA1/blob/correciones/entregas/naranjoDylan/src/reto-006/Editor.java#L52-L88) | El código usa nombres autoexplicativos (`modificarLineaActual`, `guardarEstadoPrevio`, `clonarDocumento`) que eliminan la necesidad de comentarios; la intención se lee directamente del código
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/main/entregas/naranjoDylan/src/reto-006/Editor.java#L14-L18)|JavaDoc verboso que duplica lo que el código ya comunica: "ArrayDeque como stack LIFO" es redundante cuando el tipo y uso ya lo indican; comentarios así ralentizan la lectura|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/1)
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/main/entregas/naranjoDylan/src/reto-006/Edlin.java#L7)|Comentario sobre extensión `.edin` que debería estar en documentación externa; mezclar decisiones de diseño con implementación genera ruido|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/1)
