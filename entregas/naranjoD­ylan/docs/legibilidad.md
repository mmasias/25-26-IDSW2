...
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/correciones/entregas/naranjoDylan/src/reto-006/Edlin.java)|No existen pruebas automatizadas (JUnit) para validar flujos de carga/guardado; implementar `EdlinTest.java` elevaría la calidad y prevención de regresiones|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/4)
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/correciones/entregas/naranjoDylan/src/reto-006/Menu.java)|La clase `Menu` mezcla responsabilidades de presentación y validación de entrada, violando SRP; separar en `MenuView` y `EntradaValidator` mejoraría mantenibilidad|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/4)
...
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/correciones/entregas/naranjoDylan/src/reto-006/Edlin.java#L28-L34)|Los mensajes alternan entre interrogativo ("¿Desea guardar...?") y enunciativo sin patrón; estandarizar con formato `[ACCION/INFO] Mensaje` mejoraría UX|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/5)
||[Ejemplo -](https://github.com/DylanNrj/24-25-EDA1/blob/correciones/entregas/naranjoDylan/src/reto-006/Editor.java#L70-L94)|Los mensajes de éxito usan punto final ("Deshecho.") pero los de error no lo usan consistentemente; unificar puntuación y tono reduce fricción cognitiva|[PR corrección](https://github.com/DylanNrj/24-25-EDA1/pull/5)
